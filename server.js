...
Recipes.create('taco', ['tortilla', 'ground beef', 'salsa']);
Recipes.create('cocoa', ['milk', 'cocoa', 'marshmallows']);
Recipes.create('eggs benedict', ['english muffin', 'eggs', 'ham', 'hollandaise sauce']);
